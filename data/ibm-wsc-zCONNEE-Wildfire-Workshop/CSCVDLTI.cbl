      ...
      * GET Request and Response
       01 DELETE-REQUEST.
           COPY IMS02Q01 SUPPRESS.
       01 DELETE-RESPONSE.
           COPY IMS02P01 SUPPRESS.
      * Structure with the API information
       01 DELETE-INFO-OPER1.
           COPY IMS02I01 SUPPRESS.
      ...
      *---------------------------------------------------------------*
           MOVE NUMB of IN-BUFFER TO employee IN DELETE-REQUEST.
      ...
      * API request to zCEE
           ...
           IF MODNAME IS EQUAL TO 'CSCVDLT'
              MOVE 'CSCODLT' TO MODNAME
      ...
      * can be obtained. Display the translation result.
           IF BAQ-SUCCESS THEN
              MOVE USERID2 of DELETE-RESPONSE TO USERID of OUT-BUFFER
      ...
      *  of this error. Note that DELETE-RESPONSE is not populated.
           ELSE
