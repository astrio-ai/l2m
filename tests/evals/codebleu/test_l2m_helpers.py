"""Tests for L2M helper functions."""

import pytest
from pathlib import Path
from unittest.mock import patch, MagicMock

from evals.codebleu.l2m_helpers import (
...
@patch("evals.codebleu.l2m_helpers.subprocess.run")
def test_run_l2m_modernization_success(mock_run, tmp_path):
    """Test running L2M modernization successfully."""
    cobol_file = tmp_path / "HELLO.cbl"
    cobol_file.write_text("IDENTIFICATION DIVISION.")
...
@patch("evals.codebleu.l2m_helpers.subprocess.run")
def test_run_l2m_modernization_failure(mock_run, tmp_path):
    """Test running L2M modernization with failure."""
    cobol_file = tmp_path / "HELLO.cbl"
    cobol_file.write_text("IDENTIFICATION DIVISION.")
