...
def main(argv=None, input=None, output=None, force_git_root=None, return_coder=False):
    ...
    if args.dark_mode:
        ...
        args.user_input_color = "#B4B4B4"     # Medium gray for user input
    ...
    if USE_TEXTUAL:
        ...
        def run_l2m_logic():
            ...
            try:
                ...
                _continue_main_with_io(io, args, parser, git_root, repo, input, output)
            except Exception as e:
                import traceback
    ...
    return _continue_main_with_io(io, args, parser, git_root, repo, input, output)


def _continue_main_with_io(io, args, parser, git_root, repo, input, output):
    """
