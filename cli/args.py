...
from cli.args_formatter import (
    DotEnvFormatter,
...
def get_parser(default_config_files, git_root):
    ...
    group.add_argument(
        "--user-input-color",
        default="#FFFFFF",
        help="Set the color for user input (default: #FFFFFF - white, Codex-style)",
    )
    group.add_argument(
        "--tool-output-color",
        default=None,
    ...
    group.add_argument(
        "--tool-error-color",
        default="#FF5050",
        help="Set the color for tool error messages (default: #FF5050 - bright red, Codex-style)",
    )
    group.add_argument(
        "--tool-warning-color",
        default="#FFA500",
        help="Set the color for tool warning messages (default: #FFA500 - orange, Codex-style)",
    )
    group.add_argument(
        "--assistant-output-color",
        default="#808080",
        help="Set the color for assistant output (default: #808080 - gray, Codex-style secondary text)",
    )
    group.add_argument(
    ...
    group.add_argument(
        ...
        default="monokai",
        help=(
            "Set the markdown code theme (default: monokai, other options include"
            " solarized-dark, solarized-light, dracula, or any Pygments builtin style,"
    ...
    if command == "md":
        ...
        if len(sys.argv) > 2:
            ...
            if shell not in shtab.SUPPORTED_SHELLS:
                ...
                sys.exit(1)
            parser = get_parser([], None)
            parser.prog = "src"  # Set the program name on the parser
