...
from src.core.models import model_info_manager
...
mixpanel_project_token = "d20809942b5308bba23c95e8d88627ae"
    ...
    def enable(self):
        ...
        if mixpanel_project_token:
            try:
                ...
                # If Mixpanel fails to initialize, disable it and continue
                self.mp = None

        api_key = self.custom_posthog_project_api_key or posthog_project_api_key
