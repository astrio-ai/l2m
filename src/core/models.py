...
from src.core.sendchat import ensure_alternating_roles, sanity_check_messages
from src.utils import check_pip_install_extra
...
MODEL_SETTINGS = []
with importlib.resources.open_text("src.resources", "model-settings.yml") as f:
    ...
    def simple_send_with_retries(self, messages):
        ...
        while True:
            try:
                ...
                from src.analysis.reasoning_tags import remove_reasoning_content
