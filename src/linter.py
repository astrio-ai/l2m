...
from src.run_cmd import run_cmd_subprocess  # noqa: F401
...
class Linter:
    ...
    def flake8_lint(self, rel_fname):
        ...
        try:
            ...
            # Check if flake8 is not installed (ModuleNotFoundError)
            if "No module named flake8" in errors or "No module named 'flake8'" in errors:
                # Silently skip flake8 linting if not installed
                return None
        except Exception as e:
            error_str = str(e)
            # Silently skip if flake8 is not installed
            if "No module named flake8" in error_str or "No module named 'flake8'" in error_str:
                return None
            errors = f"Error running flake8: {error_str}"
