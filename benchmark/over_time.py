...
class BenchmarkPlotter:
    ...
    def save_and_display(self, fig: plt.Figure):
        plt.savefig("l2m/website/assets/models-over-time.png")
        plt.savefig("l2m/website/assets/models-over-time.svg")
        imgcat(fig)
...
def main():
    ...
    models = plotter.load_data("l2m/website/_data/edit_leaderboard.yml")
    ...
    plotter.plot("l2m/website/_data/edit_leaderboard.yml")
