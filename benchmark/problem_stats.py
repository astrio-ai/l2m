...
def get_dirs_from_leaderboard():
    ...
    with open("l2m/website/_data/polyglot_leaderboard.yml") as f:
...
def load_results(dirname):
    ...
    for fname in benchmark_dir.glob("*/exercises/practice/*/.l2m.results.json"):
        error = False
        try:
                ...
                pass_rate = next(
                    (
                        ...
                        for entry in yaml.safe_load(
                            open("l2m/website/_data/polyglot_leaderboard.yml")
                        )
